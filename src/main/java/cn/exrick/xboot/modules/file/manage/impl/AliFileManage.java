...
public class AliFileManage implements FileManage {
    ...
    public OssSetting getOssSetting() {
        ...
        Setting setting = settingService.get(SettingConstant.OSS_TYPE.ALI_OSS.name());
    ...
    public String inputStreamUpload(InputStream inputStream, String key, MultipartFile file) {
        ...
        OSSClient ossClient = new OSSClient(os.getHttp() + os.getEndpoint(),
                new DefaultCredentialProvider(os.getAccessKey(), os.getSecretKey()), null);
