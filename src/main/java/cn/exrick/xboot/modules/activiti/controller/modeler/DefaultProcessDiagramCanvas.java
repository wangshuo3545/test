...
public class DefaultProcessDiagramCanvas {
    ...
    public void drawNoneStartEvent(GraphicInfo graphicInfo) {
        this.drawStartEvent(graphicInfo, null, 1.0D);
    }
    ...
    public void drawErrorEndEvent(GraphicInfo graphicInfo, double scaleFactor) {
        ...
        this.g.drawImage(ERROR_THROW_IMAGE, (int) (graphicInfo.getX() + graphicInfo.getWidth() / 4.0D), (int) (graphicInfo.getY() + graphicInfo.getHeight() / 4.0D), (int) ((double) ERROR_THROW_IMAGE.getWidth() / scaleFactor), (int) ((double) ERROR_THROW_IMAGE.getHeight() / scaleFactor), null);
    }

    public void drawErrorStartEvent(GraphicInfo graphicInfo, double scaleFactor) {
        this.drawNoneStartEvent(graphicInfo);
        this.g.drawImage(ERROR_CATCH_IMAGE, (int) (graphicInfo.getX() + graphicInfo.getWidth() / 4.0D), (int) (graphicInfo.getY() + graphicInfo.getHeight() / 4.0D), (int) ((double) ERROR_CATCH_IMAGE.getWidth() / scaleFactor), (int) ((double) ERROR_CATCH_IMAGE.getHeight() / scaleFactor), null);
    }
    ...
    public void drawCatchingEvent(GraphicInfo graphicInfo, boolean isInterrupting, BufferedImage image, String eventType, double scaleFactor) {
        ...
        Ellipse2D innerCircle = new Double(innerCircleX, innerCircleY, innerCircleWidth, innerCircleHeight);
        Paint originalPaint = this.g.getPaint();
        Stroke originalStroke = this.g.getStroke();
        this.g.setPaint(EVENT_COLOR);
    ...
    public void drawSequenceflow(int srcX, int srcY, int targetX, int targetY, boolean conditional, boolean highLighted, double scaleFactor) {
        ...
        java.awt.geom.Line2D.Double line = new java.awt.geom.Line2D.Double(srcX, srcY, targetX, targetY);
        this.g.draw(line);
    ...
    public void drawTask(BufferedImage icon, String name, GraphicInfo graphicInfo, double scaleFactor) {
        ...
        this.g.drawImage(icon, (int) (graphicInfo.getX() + (double) ICON_PADDING / scaleFactor), (int) (graphicInfo.getY() + (double) ICON_PADDING / scaleFactor), (int) ((double) icon.getWidth() / scaleFactor), (int) ((double) icon.getHeight() / scaleFactor), null);
    }
    ...
    protected void drawTask(String name, GraphicInfo graphicInfo, boolean thickBorder) {
        ...
        RoundRectangle2D rect = new java.awt.geom.RoundRectangle2D.Double(x, y, width, height, arcR, arcR);
        this.g.fill(rect);
    ...
    public void drawActivityMarkers(int x, int y, int width, int height, boolean multiInstanceSequential, boolean multiInstanceParallel, boolean collapsed) {
        if (collapsed) {
            if (!multiInstanceSequential && !multiInstanceParallel) {
                ...
                this.drawMultiInstanceMarker(multiInstanceSequential, x + 6 + 2, y, width, height);
            }
    ...
    public void drawParallelGateway(GraphicInfo graphicInfo, double scaleFactor) {
        ...
        if (scaleFactor == 1.0D) {
            ...
            java.awt.geom.Line2D.Double line = new java.awt.geom.Line2D.Double(x + 10, y + height / 2, x + width - 10, y + height / 2);
            this.g.draw(line);
            line = new java.awt.geom.Line2D.Double(x + width / 2, y + height - 10, x + width / 2, y + 10);
            this.g.draw(line);
    ...
    public void drawExclusiveGateway(GraphicInfo graphicInfo, double scaleFactor) {
        ...
        if (scaleFactor == 1.0D) {
            Stroke orginalStroke = this.g.getStroke();
            this.g.setStroke(GATEWAY_TYPE_STROKE);
            java.awt.geom.Line2D.Double line = new java.awt.geom.Line2D.Double(x + quarterWidth + 3, y + quarterHeight + 3, x + 3 * quarterWidth - 3, y + 3 * quarterHeight - 3);
            this.g.draw(line);
            line = new java.awt.geom.Line2D.Double(x + quarterWidth + 3, y + 3 * quarterHeight - 3, x + 3 * quarterWidth - 3, y + quarterHeight + 3);
            this.g.draw(line);
            this.g.setStroke(orginalStroke);
        }
    ...
    public void drawInclusiveGateway(GraphicInfo graphicInfo, double scaleFactor) {
        ...
        if (scaleFactor == 1.0D) {
            Stroke orginalStroke = this.g.getStroke();
            this.g.setStroke(GATEWAY_TYPE_STROKE);
            Double circle = new Double((width - diameter) / 2 + x, (height - diameter) / 2 + y, diameter, diameter);
            this.g.draw(circle);
            this.g.setStroke(orginalStroke);
        }
    ...
    public void drawMultiInstanceMarker(boolean sequential, int x, int y, int width, int height) {
        ...
        if (sequential) {
            this.g.draw(new java.awt.geom.Line2D.Double(lineX, lineY, lineX + rectangleWidth, lineY));
            this.g.draw(new java.awt.geom.Line2D.Double(lineX, lineY + rectangleHeight / 2, lineX + rectangleWidth, lineY + rectangleHeight / 2));
            this.g.draw(new java.awt.geom.Line2D.Double(lineX, lineY + rectangleHeight, lineX + rectangleWidth, lineY + rectangleHeight));
        } else {
            this.g.draw(new java.awt.geom.Line2D.Double(lineX, lineY, lineX, lineY + rectangleHeight));
            this.g.draw(new java.awt.geom.Line2D.Double(lineX + rectangleWidth / 2, lineY, lineX + rectangleWidth / 2, lineY + rectangleHeight));
            this.g.draw(new java.awt.geom.Line2D.Double(lineX + rectangleWidth, lineY, lineX + rectangleWidth, lineY + rectangleHeight));
        }
    ...
    public void drawHighLight(int x, int y, int width, int height) {
        ...
        this.g.setPaint(HIGHLIGHT_COLOR);
        this.g.setStroke(THICK_TASK_BORDER_STROKE);
        RoundRectangle2D rect = new java.awt.geom.RoundRectangle2D.Double(x, y, width, height, 20.0D, 20.0D);
        this.g.draw(rect);
        this.g.setPaint(originalPaint);
        this.g.setStroke(originalStroke);
    }
    ...
    public List<GraphicInfo> connectionPerfectionizer(org.activiti.image.impl.DefaultProcessDiagramCanvas.SHAPE_TYPE sourceShapeType, org.activiti.image.impl.DefaultProcessDiagramCanvas.SHAPE_TYPE targetShapeType, GraphicInfo sourceGraphicInfo, GraphicInfo targetGraphicInfo, List<GraphicInfo> graphicInfoList) {
        ...
        if (graphicInfoList != null && graphicInfoList.size() > 0) {
            ...
            if (shapeFirst != null) {
                lineLast = new java.awt.geom.Line2D.Double(graphicInfoFirst.getX(), graphicInfoFirst.getY(), graphicInfoList.get(1).getX(), graphicInfoList.get(1).getY());
            ...
            if (shapeLast != null) {
                lineLast = new java.awt.geom.Line2D.Double(graphicInfoLast.getX(), graphicInfoLast.getY(), graphicInfoList.get(graphicInfoList.size() - 2).getX(), graphicInfoList.get(graphicInfoList.size() - 2).getY());
