...
public class ActProcessInsController {
    ...
    @Operation(summary = "通过流程定义id获取第一个任务节点")
    public Result<ProcessNodeVo> getFirstNode(@Parameter(description ="流程定义id") @PathVariable String procDefId) {
    ...
    @Operation(summary = "通过当前节点定义id获取下一个节点")
    public Result<ProcessNodeVo> getNextNode(@Parameter(description ="当前节点定义id") @PathVariable String procDefId,
                                             @Parameter(description ="当前节点定义id") @PathVariable String currActId) {
    ...
    @Operation(summary = "通过节点nodeId获取审批人")
    public Result<ProcessNodeVo> getNode(@Parameter(description ="节点nodeId") @PathVariable String nodeId,
                                         @Parameter(description ="任务taskId") @RequestParam(required = false) String taskId,
                                         @Parameter(description ="历史任务taskId") @RequestParam(required = false) String hisTaskId) {
    ...
    @Operation(summary = "获取高亮实时流程图")
    public void getHighlightImg(@Parameter(description ="流程实例id") @PathVariable String id,
    ...
    public Result updateStatus(@Parameter(description ="流程实例id") @RequestParam String id,
    ...
    @Operation(summary = "通过id删除运行中的实例")
    ...
    @Operation(summary = "通过id删除已结束的实例")
