...
public class Oauth2Controller {
    ...
    public Result info(@Parameter(description ="客户端id") @PathVariable String client_id) {
    ...
    public Result authorize(@Parameter(description ="用户名") @RequestParam String username,
                            ...
                            @Parameter(description ="客户端id") @RequestParam String client_id,
    ...
    public Result authorized(@Parameter(description ="客户端id") @RequestParam String client_id,
                             @Parameter(description ="成功授权后回调地址") @RequestParam String redirect_uri,
                             @Parameter(description ="客户端状态值") @RequestParam String state) {
