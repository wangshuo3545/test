...
public class AutoChatController extends XbootBaseController<AutoChat, String> {
    ...
    public Object ask(@Parameter(description ="问题") @RequestParam String q,
                      @Parameter(description ="最大回答数量") @RequestParam(required = false, defaultValue = "10") Integer pageSize) {
    ...
    @Operation(summary = "联想搜索")
    public AssociateVo associate(@Parameter(description ="问题") @RequestParam String q,
                                 @Parameter(description ="最大回答数量") @RequestParam(required = false, defaultValue = "10") Integer pageSize) {
